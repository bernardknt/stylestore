...
class _CustomerPageState extends State<CustomerPage> {
  ...
  List<bool>visible = [false, false, false, false,false, false, false, false,false, false, false
  ];
  List contactList = [];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        floatingActionButton: permissionsMap['customers'] == false ? Container():FloatingActionButton(
        ...
        appBar:AppBar(
          ...
          title: Text('Customers', style: kNormalTextStyle.copyWith(color: kBlack, fontSize: 16),),
          elevation: 0,
          centerTitle: true,
          actions: [
        ...
        body: permissionsMap['customers'] == false ? LockedWidget(page: "Customers"):Column(
          children: [
            Padding(
                  ...
                  Container(
                      ...
                      child: Row(
                        children: const [
                          ...
                          kSmallWidthSpacing,
                          Text("Search Customers", style: kNormalTextStyle,)
                        ],
                      ))
              ),
            ),
            ...
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                  stream: FirebaseFirestore.instance.collection('customers').where('active', isEqualTo: true).where
                    ...
                    if (!snapshot.hasData) {
                      ...
                      CustomPopupWidget(backgroundColour: kBlueDarkColor,actionButton: 'Add Customer', subTitle: 'Add Customers: Tap and sell', image: 'customer.jpg', title: 'Build Loyal Customers', function:
                          (){
                                          ...
                                          child: Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children:
                                                [
                                                  buildButton(context, 'Edit ${customerNameList[index]}', Iconsax.pen_add,
                                                          () async {
                                                  ...
                                                  buildButton(context, 'Buying History of ${customerNameList[index]}', Iconsax.money_send,  () async {
                                                    Navigator.pop(context);
                                                  ...
                                                  items.length != 0 ?buildButton(context, '${customerNameList[index]} Extra Details', Iconsax.personalcard,  () async {
                                                    Navigator.pop(context);
                                                    showDialog(context: context, builder: (BuildContext context){
                                                      return
                                                        GestureDetector(
                                                                    ...
                                                                    ListView.builder(
                                                                          ...
                                                                          itemBuilder: (context, i){
                                                                            return CustomerContentsWidget(
                                                                                orderIndex: i + 1,
                                                                                optionName: items[index].keys.toList()[i],
                                                                                optionValue: items[index].values.toList()[i]
                                                                            );
                                          ...
                                          children: [
                                            ListTile(
                                              ...
                                              title: Column(
                                                ...
                                                children: [
                                                  Text(capitalizeString( customerNameList[index]), style: kNormalTextStyleMoney.copyWith(fontSize: 14),),
                                                  Text('${phoneNumberList[index]}', style: kNormalTextStyleDark,),
                                                  Text('Location: ${capitalizeString(locationList[index]) }', style: kNormalTextStyleDark,),
                                                  Text('Note: ${capitalizeString(infoList[index])}', style: kNormalTextStyleDark,),

                                                ],
                                              ),
                                              subtitle:
                                              phoneNumberList[index]!=""?Padding(
                                                padding: const EdgeInsets.only(right: 80.0, top: 10),
                                                child: RoundedButtons(buttonColor: kBlueDarkColor, title: "Call", onPressedFunction: (){
                                                  CommonFunctions().callPhoneNumber(phoneNumberList[index]);

                                                }, buttonWidth: 10,buttonHeight: 30,),
                                              ):Container(),
                                                    ...
                                                    onTap: (){
                                                      CoolAlert.show(
                                                          ...
                                                          onConfirmBtnTap: (){
                                                            ...
                                                            CommonFunctions().removeDocumentFromServer(id[index], 'customers');
                                            ...
                                            Positioned(
                                                ...
                                                child: GestureDetector(
                                                    onTap: (){
                                                      Share.share('Name: ${customerNameList[index]}\nNumber: ${phoneNumberList[index]}\nLocation: ${locationList[index]}', subject: 'Check this out from Nutri');
                                                    ...
                                                    child: CircleAvatar(
                                                      backgroundColor: kCustomColor,
                                                        radius: 15,
                                                        child: Icon(Iconsax.share, size: 15,)))),
