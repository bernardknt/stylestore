...
class TransactionsProducts extends StatefulWidget {
  static String id = 'products_orders_page';

  @override
  _TransactionsProductsState createState() => _TransactionsProductsState();
}

class _TransactionsProductsState extends State<TransactionsProducts> {
  ...
  return Scaffold(
    appBar: AppBar(
      ...
      elevation: 0,
      title: Text("Transactions", style: kNormalTextStyle,),
    ),
