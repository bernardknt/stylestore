...
class _POSState extends State<POS> {
        ...
        if (index != -1) {
          ...
          if (trackingList[index]== true) {
            if(1 <= quantityList[index]){
              ...
              Provider.of<StyleProvider>(context, listen: false).addToServiceBasket(BasketItem(name:  nameList[index], quantity: 1.0, amount: amountList[index]/1.0, details: descList[index], tracking: trackingList[index]));
              selectedStocks.add(Stock(name: nameList[index], id: idList[index], restock: 1, price: amountList[index]/1.0));
              showDialog(
                context: context,
              ...
              showDialog(context: context, builder: (BuildContext context){
                return
                  CupertinoAlertDialog(
                    ...
                    content: Text("The quantity available for ${nameList[index]} is ${quantityList[index]}! You have tried to sell 1 unit!", style: kNormalTextStyle.copyWith(color: kBlack),),
                    actions: [
            ...
            Provider.of<StyleProvider>(context, listen: false).addToServiceBasket(BasketItem(name:  nameList[index], quantity: 1.0, amount: amountList[index]/1.0, details: descList[index], tracking: trackingList[index]));
            ScaffoldMessenger.of(context).showSnackBar( SnackBar(content: Text('TRACKING TRUE ${nameList[index]} added')));
            showDialog(
              context: context,
              builder: (BuildContext context) {
                return CupertinoAlertDialog(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        permissionsMap['sales'] == false ? Container():GestureDetector(
          ...
          Container(
              ...
              child: Text('+ Add Customer', style: kNormalTextStyle.copyWith(color: kPureWhiteColor ,fontSize: 13),)),
        ),
        centerTitle: true,
        actions: [
          Padding(
            ...
            child: GestureDetector(
                ...
                child: Icon(Iconsax.scan, size: 40,)),
          )
        ],
      ),
      floatingActionButton:  permissionsMap['sales'] == false ? Container():
      isStoreEmpty == true? Container():
      FloatingActionButton.extended(
        ...
        onPressed: () async{
          ...
          if(Provider.of<StyleProvider>(context, listen: false).basketItems.length == 0){
            CommonFunctions().AlertPopUpDialogueMain(context, imagePath: 'images/delivery.json', title: 'No Items Added', text: 'Add some Items');
            ...
            if(Provider.of<StyleProvider>(context, listen: false).customerName == ""){
              ...
              //       return PosSummary();
              //     });
              CommonFunctions().AlertPopUpCustomers(context, imagePath: 'images/leave.json', title: 'No Customer Added', text: 'Add a Customer', cancelButtonText: "Continue", selectedStocks: selectedStocks);
      ...
      body: permissionsMap['sales'] == false ? LockedWidget(page: "Point Of Sale"):
      Stack(
        children: [
          Container(
            height: 100,
            ...
            Center(child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text('No Customer Selected', style: kNormalTextStyle.copyWith(color: kPureWhiteColor,fontSize: 12),):
                  Text('${Provider.of<StyleProvider>(context).customerName} (${Provider.of<StyleProvider>(context).customerNumber})', style: kNormalTextStyle.copyWith(color: kPureWhiteColor,fontSize: 16),),
                  kSmallHeightSpacing,
                  Text('Selected Items', style: kNormalTextStyle.copyWith(color: kAppPinkColor ,fontSize: 12),),
                  Text('${Provider.of<StyleProvider>(context).basketNameItems.join(", ")}',textAlign: TextAlign.center, style: kNormalTextStyle.copyWith(color: kPureWhiteColor ,fontSize: 12),),
                ...
                Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        kSmallWidthSpacing,
                        Text("Search Items", style: kNormalTextStyle,)
                      ],
                    ))
              ),
          ...
          Padding(
            ...
            child: StreamBuilder<QuerySnapshot>(
                ...
                builder: (context, snapshot) {
                  ...
                  // if (descList.isEmpty) {
                  //
                  //   Provider.of<StyleProvider>(context, listen: false).setIsStoreEmpty(true);
                  //
                  // } else {
                  //   Provider.of<StyleProvider>(context, listen: false).setIsStoreEmpty(false);
                  // }

                  return
                    descList.isEmpty?
                  CustomPopupWidget(backgroundColour: kBlueDarkColor ,actionButton: 'Create Product', subTitle: 'Add Products: Tap and sell', image: 'tap.jpg', title: 'Sell like a Pro', function:
                        ...
                        itemBuilder: (context, index) {
                          return GestureDetector(
                              onTap: () {
                                ...
                                amount = amountList[index].toDouble();
                                quantity = 1.0;
                                showDialog(
                                    context: context,
                                    builder: (BuildContext context) {
                                      return AlertDialog(
                                        ...
                                        content: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              InputFieldWidget(readOnly: true,hintText: "", controller: nameList[index], onTypingFunction: (value){}, keyboardType: TextInputType.text, labelText: "Name 🔒"),
                                              InputFieldWidget(readOnly: false,hintText: "", controller: descList[index], onTypingFunction: (value){description = value;}, keyboardType: TextInputType.text, labelText: "Description"),
                                              InputFieldWidget(readOnly: false,hintText: "", controller: "1", onTypingFunction: (value){quantity = double.parse(value); }, keyboardType: TextInputType.number, labelText: "Quantity"),
                                              InputFieldWidget(readOnly: false,hintText: "", controller: amountList[index].toString(), onTypingFunction: (value){amount = double.parse(value);}, keyboardType: TextInputType.number, labelText: "Price"),
                                              Row(
                                                ...
                                                children: [
                                                  ...
                                                  ElevatedButton(
                                                    onPressed: () {
                                                      ...
                                                      if (trackingList[index]== true) {
                                                        if(quantity <= quantityList[index]){
                                                          Provider.of<StyleProvider>(context, listen: false).addToServiceBasket(BasketItem(name:  nameList[index], quantity: quantity, amount: amount, details: description, tracking: trackingList[index]));
                                                          selectedStocks.add(Stock(name: nameList[index], id: idList[index], restock: quantity, price: amount/1.0));
                                                          Navigator.pop(context);
                                                        } else {
                                                          Navigator.pop(context);
                                                          showDialog(context: context, builder: (BuildContext context){
                                                            return
                                                              CupertinoAlertDialog(
                                                                title: const Text('Quantity Too High'),
                                                                content: Text("The quantity available for ${nameList[index]} is ${quantityList[index]}! You have tried to sell ${quantity} units!", style: kNormalTextStyle.copyWith(color: kBlack),),
                                                                actions: [
                                                      ...
                                                      print("THIS IS AT POS STAGE $selectedStocks with quantity to reduce ${selectedStocks[0].restock}");
                                  ...
                                  ListTile(
                                      title: Column(
                                        ...
                                        children: [
                                          ...
                                          trackingList[index]== false?Container():
                                          // If the minimum quantity at index is greater or equal to the current quantity
                                          minimumList[index] >= quantityList[index]?Text(
                                            "Qty: ${quantityList[index].toString()}",
                                            overflow: TextOverflow.clip,
                                            style: kHeadingTextStyle.copyWith(fontSize: 12, color: Colors.red),):Text(
                                            "Qty: ${quantityList[index].toString()}",
                                            overflow: TextOverflow.clip,
                                            style: kHeadingTextStyle.copyWith(fontSize: 12, color: kGreenThemeColor),),
                                        ],
                                      ),
                                      trailing: Text("Ugx ${ CommonFunctions().formatter.format(amountList[index])}",style: kNormalTextStyle.copyWith(color: kGreenThemeColor, fontSize: 13),)
                                  ),
                                  TicketDots(
          ...
          isStoreEmpty== true? Container() : Positioned(
              bottom: 50,
              right: 5,
              child: Column(
                children: [
