...
Future<void> addMobileMoneyTransaction(String name,String amount, String amountToCharge, String orderId, String email,storeId, purpose, context ) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () async{
                                  ...
                                  addMobileMoneyTransaction(product.client, balance.toString(), amountToCharge, orderId, product.id, product.storeId,"Invoice Payment", context);
                                },
                                child: Text(
          ...
          ):Container(child: Center(child: Text("This invoice was fully paid ")),);
        },
      ),
    );
  }
