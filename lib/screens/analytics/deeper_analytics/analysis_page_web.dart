...
class AnalysisPageWeb extends StatefulWidget {
  static String id = "Analysis_Management_web";

  @override
  State<AnalysisPageWeb> createState() => _AnalysisPageWebState();
}

class _AnalysisPageWebState extends State<AnalysisPageWeb> {
