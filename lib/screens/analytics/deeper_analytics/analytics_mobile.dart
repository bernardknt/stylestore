...
class AnalyticsMobile extends StatefulWidget {
  static String id = "Analytics_Page_Mobile";
  const AnalyticsMobile({super.key});

  @override
  State<AnalyticsMobile> createState() => _AnalyticsMobileState();
}

class _AnalyticsMobileState extends State<AnalyticsMobile> {
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  kLargeHeightSpacing,
                  Text('Customers & Products',textAlign: TextAlign.center,style: kNormalTextStyle.copyWith(fontWeight: FontWeight.bold,color: kBlack ),),
                  kLargeHeightSpacing,
                  Row(
                    children: [
                      Container(
