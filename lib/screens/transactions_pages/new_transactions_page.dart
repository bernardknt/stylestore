                                                          ...
                                                          children: [
                                                            GestureDetector(
                                                              onTap: () async{
                                                                ...
                                                                if (paidAmountList[index]< priceList[index]) {
                                                                  Navigator.pop(context);
                                                                  ...
                                                                  final pdfFile = await PdfInvoicePdfHelper
                                                                      .generate(invoice, "invoice_${transIdList[index]}", logo);
                                                                          ...
                                                                          child: Container(
                                                                            ...
                                                                            child: Padding(
                                                                              ...
                                                                              child: Column(
                                                                                ...
                                                                                children:
                                                                                [
                                                                                  _buildButton(context, 'Invoice', Iconsax.printer,
                                                                                          () async {
                                                                                        Navigator.pop(context);
                                                                                        Navigator.pop(context);
                                                                                  ...
                                                                                  _buildButton(context, 'Receipt', Iconsax.receipt,  () async {
                                                                                    Navigator.pop(context);
                                                                                    Navigator.pop(context);
                                                                                    final invoice = Invoice(
                                                                                        supplier: Supplier(
