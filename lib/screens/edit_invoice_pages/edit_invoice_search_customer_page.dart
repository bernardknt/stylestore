...
class EditCustomerSearchPage extends StatefulWidget {
  static String id = "edit_search_customer";
  @override
  _EditCustomerSearchPageState createState() => _EditCustomerSearchPageState();

}

class _EditCustomerSearchPageState extends State<EditCustomerSearchPage> {
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return GestureDetector(
                            onTap: (){
                              ...
                              Provider.of<StyleProvider>(context, listen:false).setInvoicedCustomer(name,phoneNumber, id);
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        onTap: (){
                          ...
                          Provider.of<StyleProvider>(context, listen:false).setInvoicedCustomer(name,phoneNumber, id);
                          //setCustomerName(name, phoneNumber, id, location);
                          Navigator.pop(context);
