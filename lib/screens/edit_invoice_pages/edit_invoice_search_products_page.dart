...
class EditInvoiceProductSearch extends StatefulWidget {
  static String id = "invoice_search_product";
  @override
  _EditInvoiceProductSearchState createState() => _EditInvoiceProductSearchState();

}

class _EditInvoiceProductSearchState extends State<EditInvoiceProductSearch> {
                                              ...
                                              children: [
                                                ...
                                                ElevatedButton(
                                                  onPressed: () {
                                                    ...
                                                    // } else {
                                                     // Provider.of<StyleProvider>(context, listen: false).addToServiceBasket(BasketItem(name:  name, quantity: quantity, amount: amount, details: description, tracking: tracking));
                                                      Provider.of<StyleProvider>(context, listen: false).addInvoicedItems(InvoiceItem(name: name, quantity: quantity, unitPrice: amount));
                                                      Navigator.pop(context);
                                                      Navigator.pop(context);
                                                    // }
                  ...
                  children: [
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Center(child: Icon(Icons.add, color: kPureWhiteColor,),),
                      )
                    ),
