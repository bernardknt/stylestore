...
import 'package:stylestore/screens/bluetoothPage.dart';
...
import 'package:stylestore/screens/new_printer.dart';
      ...
      [
        ...
        child: GetMaterialApp(
          ...
          routes: {
            ...
            // NewPrinter.id: (context) => NewPrinter(),
            ...
            // BluetoothPage.id: (context) => BluetoothPage(),
            // NewPrinter.id: (context) => NewPrinter(),
            // NewPrinterDonePerfect.id: (context) => NewPrinterDonePerfect(),
            ...
            CustomerTransactionsProducts.id: (context) => CustomerTransactionsProducts(),
